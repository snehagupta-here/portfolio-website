...
function AdminContact() {
  return (
    ...
    <h1 className='font-[700] mt-[70px] text-[25px] '>Contact</h1>
      <div  className='w-[1200px] h-auto py-8 shadows mt-[50px]  rounded-[20px] flex flex-col justify-evenly content-between'>
        <div className='flex justify-evenly'>
          <div className='flex flex-col'><h1 className='text-[15px] font-[600]'>Email</h1><div className='h-[54px] w-[333px] bg-[#006BC2] pt-3 pl-3 text-white rounded-[10px]'>somemail@gmail.com<img src={pen} className='w-[22px] h-[22px] inline ml-24 mr-2' /><FontAwesomeIcon icon={faCircleXmark} className='mr-2 mt-1' /></div></div>
