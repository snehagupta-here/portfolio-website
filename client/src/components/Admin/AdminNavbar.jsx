...
function AdminNavbar() {
  return (
    <nav className='flex fixed w-[100%] overflow-x-hidden h-[100px] bg-white z-10 items-center'>
...
<div className='h-[48px] nav-left w-[100px] bg-gradient-to-r from-[#00D5C8] to-[#0400D8] ml-[120px] rounded-e-[100px]'></div>
      ...
      <div className=' text-[18px] font-[300] ml-[429px] justify-self-end absolute right-0 navList'>
